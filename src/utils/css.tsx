...
export const tableTH =
  "p-2 border-[1px] border-gray-300 bg-blue-600 text-white text-sm font-medium cursor-pointer";
export const tableTD = "p-2 border-[1px] border-gray-300";

// Search input css
export const searchInputCss =
  "w-[300px] max-w-[300px] h-[40px] px-5 max-w-[200px] rounded-md border-[1px] border-gray-400";
